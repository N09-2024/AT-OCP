    ...
    <Box sx={{ p: 3 }}>
      ...
      {loading ? (
        ...
        <Paper sx={{ p: 4, textAlign: 'center', borderRadius: 3, border: '1px solid #e2e8f0' }}>
          <DoneAllIcon sx={{ fontSize: 48, color: '#00875A', mb: 2 }} />
        ...
        <TableContainer component={Paper} sx={{ borderRadius: 3, border: '1px solid #e2e8f0', boxShadow: 'none' }}>
          <Table>
            <TableHead sx={{ bgcolor: '#f0fdf4' }}>
              <TableRow>
                <TableCell sx={{ fontWeight: 800, color: '#065f46' }}>N° AT</TableCell>
                <TableCell sx={{ fontWeight: 800, color: '#065f46' }}>Objet de l'intervention</TableCell>
                <TableCell sx={{ fontWeight: 800, color: '#065f46' }}>Zone / Service P</TableCell>
                <TableCell sx={{ fontWeight: 800, color: '#065f46' }}>Date prévue</TableCell>
                <TableCell sx={{ fontWeight: 800, color: '#065f46' }}>Statut AT</TableCell>
                <TableCell sx={{ fontWeight: 800, color: '#065f46' }}>Réception CEEE</TableCell>
                <TableCell align="right" sx={{ fontWeight: 800, color: '#065f46' }}>Actions</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {ats.map((at) => (
                <TableRow key={at.id} hover>
                  <TableCell sx={{ fontWeight: 800, color: '#00875A' }}>
                    {at.numero}
                  </TableCell>
                      ...
                      <Tooltip title={hasAlreadySigned(at) ? 'Apposer votre visa (déjà réceptionné)' : 'Accuser réception et signer'}>
                        <Button
                          ...
                          sx={{
                            ...
                            borderRadius: 2,
                            px: 2,
                            bgcolor: hasAlreadySigned(at) ? 'transparent' : '#00875A',
                            '&:hover': { bgcolor: hasAlreadySigned(at) ? '#f0fdf4' : '#047857' },
                          }}
                        >
