  ...
  const actions = [
    {
      ...
      icon: <CloudArrowUpIcon width={32} color="#ea580c" />,
      color: '#ea580c',
      bgcolor: '#ea580c18',
    ...
    },
    {
      ...
      icon: <CameraIcon width={32} color="#7c3aed" />,
      color: '#7c3aed',
      bgcolor: '#7c3aed18',
    ...
    },
    {
      ...
      icon: <MagnifyingGlassCircleIcon width={32} color="#0891b2" />,
      color: '#0891b2',
      bgcolor: '#0891b218',
      path: '/permis',
      ...
      <Box sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
          ...
          <Chip
            ...
            size="small"
            sx={{ bgcolor: '#ea580c18', color: '#ea580c', fontWeight: 700 }}
          />
        </Box>
