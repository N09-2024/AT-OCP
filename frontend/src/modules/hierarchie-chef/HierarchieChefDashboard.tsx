...
export const HierarchieChefDashboard: React.FC = () => {
  ...
  const cardsExecutant = [
    {
      ...
      icon: <VerifiedUserIcon sx={{ fontSize: 32, color: '#3C7A5C' }} />,
      color: '#3C7A5C',
      highlight: true,
    },
    {
      ...
      icon: <SecurityIcon sx={{ fontSize: 32, color: '#3C7A5C' }} />,
      color: '#3C7A5C',
    },
  ];
  ...
  const cardsProprietaire = [
    ...
    },
    {
      ...
      icon: <HistoryIcon sx={{ fontSize: 32, color: '#3C7A5C' }} />,
      color: '#3C7A5C',
    },
  ];
          ...
          <Grid key={i} size={{ xs: 12, sm: 6, md: 4 }}>
            <Card
              sx={{
                ...
                borderRadius: 3,
                boxShadow: c.highlight ? '0 10px 25px -5px rgba(60,122,92,0.18)' : '0 1px 3px rgba(0,0,0,0.08)',
