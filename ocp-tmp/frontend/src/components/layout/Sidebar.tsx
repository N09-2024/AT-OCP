...
const HCEE_MENU = {
  label: 'HCEE — Hors Cadre Exécutant (Garant)',
  sections: [
    {
      title: 'Garantie & Validation (§8)',
      items: [
        { text: 'Tableau de bord', path: '/dashboard', icon: <HomeIcon width={20} /> },
        { text: 'AT à garantir / valider', path: '/autorisations?filtre=SOUMISE', icon: <CheckBadgeIcon width={20} /> },
...
// ─── HCEP// ─── HCEP (Hors Cadre Entité Propriétaire) ──────────────
const HCEP_MENU = {
  label: 'HCEP — Hors Cadre Propriétaire (Garant)',
  sections: [
    {
      title: 'Classification & Garantie (§6–§8)',
      items: [
        { text: 'Tableau de bord', path: '/dashboard', icon: <HomeIcon width={20} /> },
        { text: 'Classifier une intervention', path: '/documents', icon: <DocumentTextIcon width={20} /> },
        { text: 'AT de mon périmètre', path: '/autorisations', icon: <ClipboardDocumentCheckIcon width={20} /> },
      ],
    },
    {
      title: 'Pilotage',
      items: [
        { text: 'Habilitations agents AT', path: '/administration/habilitations', icon: <ShieldCheckIcon width={20} /> },
        { text: 'Archives (garant)', path: '/archives', icon: <FolderIcon width={20} /> },
        { text: 'Notifications', path: '/notifications', icon: <BellIcon width={20} /> },
      ],
    },
  ],
...
// ─── HMEP// ─── HMEP (Haute Maîtrise Entité Propriétaire) ──────────
const HMEP_MENU = {
  label: 'HMEP — Haute Maîtrise Propriétaire (Garant terrain)',
  sections: [
    {
      title: 'Garantie opérationnelle',
      items: [
        { text: 'Tableau de bord', path: '/dashboard', icon: <HomeIcon width={20} /> },
        { text: 'AT à garantir (soumises)', path: '/autorisations?filtre=SOUMISE', icon: <CheckBadgeIcon width={20} /> },
        { text: 'Visites chantier', path: '/visites', icon: <MapPinIcon width={20} /> },
      ],
    },
    {
      title: 'Suivi',
      items: [
        { text: 'Toutes les ATs', path: '/autorisations', icon: <ClipboardDocumentCheckIcon width={20} /> },
        { text: 'Permis', path: '/permis', icon: <ShieldCheckIcon width={20} /> },
        { text: 'Notifications', path: '/notifications', icon: <BellIcon width={20} /> },
      ],
    },
  ],
...
// ─── HMEE// ─── HMEE (Haute Maîtrise Entité Exécutante) ────────────
const HMEE_MENU = {
  label: 'HMEE — Haute Maîtrise Exécutante (Garant)',
  sections: [
    {
      title: 'Garantie côté exécutant',
      items: [
        { text: 'Tableau de bord', path: '/dashboard', icon: <HomeIcon width={20} /> },
        { text: 'AT à garantir', path: '/autorisations?filtre=SOUMISE', icon: <CheckBadgeIcon width={20} /> },
        { text: 'Interventions en cours', path: '/autorisations?filtre=VALIDEE', icon: <ClipboardDocumentListIcon width={20} /> },
      ],
    },
    {
      title: 'Suivi',
