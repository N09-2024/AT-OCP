...
## Parcours utilisateurs (CE / HM / HC)

| Fonction | Rôles | Action principale |
|----------|-------|-------------------|
| **CE** | CEEP | Formulaire A–G → Visa CEEP → Soumettre |
| **CE** | CEEE | Même formulaire → Visa CEEE |
| **HM** | HMEP / HMEE | Garantir AT soumises (visite, démarrage) |
| **HC** | HCEP | Classification N1/N2, habilitations, garant archive |
| **HC** | HCEE | Garantir / valider dossier soumise, archive |

Voir aussi `docs/ROLES_HM_HC_CE.md`.
