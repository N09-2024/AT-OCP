...
export const PermissionGuard: React.FC<{
  ...
  return (
    <Box sx={{ p: 4, maxWidth: 600, mx: 'auto', mt: 4 }}>
      <Paper sx={{ p: 4, textAlign: 'center', border: '1px solid #FBEAE3', bgcolor: '#F7FAF8' }}>
        <LockIcon sx={{ fontSize: 48, color: '#9A3D2F', mb: 2 }} />
        <Typography variant="h6" color="#2E624A" gutterBottom sx={{ fontWeight: 700 }}>
          Accès Non Autorisé
        </Typography>
        <Typography variant="body2" color="#7A2E1A" sx={{ mb: 3 }}>
