                  ...
                  <TableRow key={user.id} hover sx={{ '&:last-child td': { border: 0 } }}>
                    <TableCell>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                        <Avatar sx={{ width: 34, height: 34, bgcolor: '#3C7A5C', fontSize: 13, fontWeight: 700 }}>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        sx={{
                          ...
                          bgcolor: user.actived ? '#EDF2EE' : '#F7FAF8',
                          color: user.actived ? '#3C7A5C' : '#5C6E67',
                          border: `1px solid ${user.actived ? '#7FC8A9' : '#D6E3DC'}`,
                        }}
                      />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell align="right">
                      ...
                      <IconButton
                        size="small"
                        sx={{
                          color: user.actived ? '#9A3D2F' : '#3C7A5C',
                          '&:hover': { bgcolor: user.actived ? '#FBEAE3' : '#EDF2EE' },
                        }}
